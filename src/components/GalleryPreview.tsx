...
const galleryImages = [
    {
        src: "/DSC_0118.webp",
        alt: "Boxxera training session",
        span: "md:col-span-2 md:row-span-2",
    },
    {
        src: "/DSC_0087.webp",
        alt: "Coach correction at Boxxera",
        span: "md:col-span-1 md:row-span-1",
    },
    {
        src: "/DSC_0525.webp",
        alt: "Boxxera studio atmosphere",
        span: "md:col-span-1 md:row-span-1",
    },
    {
        src: "/2022-03-13.webp",
        ...
        <section className="bg-black py-24 md:py-32 overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div className="mb-16">
                    ...
                    >
                        Inside the Grind <br className="hidden md:block" /> at Boxxera
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
